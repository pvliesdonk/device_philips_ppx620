...
RELINK_SOURCE_FILES +=  $(TARGET_OUT_EXECUTABLES)/sqlite3
RELINK_SOURCE_FILES +=  $(TARGET_OUT_SHARED_LIBRARIES)/libsqlite.so
RELINK_SOURCE_FILES +=  $(TARGET_OUT_SHARED_LIBRARIES)/libicuuc.so
RELINK_SOURCE_FILES +=  $(TARGET_OUT_SHARED_LIBRARIES)/libicui18n.so
